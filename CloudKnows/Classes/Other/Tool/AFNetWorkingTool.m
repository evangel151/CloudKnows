...
+(void)GET:(NSString *)url
   ...
   success:(ResponseSuccess)success
    ...
    AFHTTPSessionManager *manager = [AFNetWorkingTool managerWithBaseURL:nil sessionConfiguration:NO];
    
    [manager GET:url parameters:params progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        
        id dic = [AFNetWorkingTool responseConfiguration:responseObject];
        success(task,dic);
...
+ (void)GET:(NSString *)url baseURL:(NSString *)baseUrl params:(NSDictionary *)params
    ...
    AFHTTPSessionManager *manager = [AFNetWorkingTool managerWithBaseURL:baseUrl sessionConfiguration:NO];
...
+ (void)uploadWithURL:(NSString *)url
    ...
    AFHTTPSessionManager *manager = [AFNetWorkingTool managerWithBaseURL:baseurl sessionConfiguration:YES];
